      ...
      <div className="grid md:grid-cols-3 gap-12">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-primary-foreground/70">
            ...
            <li className="flex items-center gap-2"><Phone size={16} className="text-accent shrink-0" /> +91-XXXXX-XXXXX</li>
            <li className="flex items-center gap-2"><Mail size={16} className="text-accent shrink-0" /> info@sahasratech.com</li>
          </ul>
        </div>
      </div>
